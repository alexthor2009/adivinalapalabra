...
function check(){
    ...
    if(question_turn == "player1")
    {
        ...
        document.getElementById("player_question").innerHTML = "Turno para preguntas - "+ player2_name;
    }
    else
    {
        question_turn = "player1"
        document.getElementById("player_question").innerHTML = "Turno para preguntas - "+ player1_name;  
    }
